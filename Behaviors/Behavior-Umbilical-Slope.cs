  ...
  public class DescentUVBehavior : BehaviorBase
  {
    ...
    public override void Execute(AgentBase agent)
    {
      ...
      if(minDelta < delta)
      {
        ...
        move2D.Unitize();
        double slope = Math.Abs(minDelta - delta) / Factor * 1000;
        move2D *= slope;
        //Rhino.RhinoApp.WriteLine("Agent " + myAgent.Id + " Slope: " + slope);
        //Rhino.RhinoApp.WriteLine("Agent " + myAgent.Id + " Factor: " + Factor);
